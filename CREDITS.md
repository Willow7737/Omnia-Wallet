...
- Google "G" logo — © Google LLC, used to identify "Sign in with Google" per
  Google's [sign-in branding guidelines](https://developers.google.com/identity/branding-guidelines).
- GitHub mark — © GitHub, Inc., used to identify GitHub sign-in per
  [GitHub logo usage](https://github.com/logos).

## Photography (onboarding + news)
...
CC BY 2.0: <https://creativecommons.org/licenses/by/2.0/> — images unmodified
except for scaling/cropping to fit.
